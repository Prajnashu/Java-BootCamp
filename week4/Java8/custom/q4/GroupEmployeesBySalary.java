...
public class GroupEmployeesBySalary {
    public static void main(String[] args) {
        ...
        Map<String, List<String>> groups = employeeStream.collect(Collectors.groupingBy(GroupEmployeesBySalary::myFunction, Collectors.mapping(Employee::getName, Collectors.toList())));
        System.out.println(groups);
    }

    public static String myFunction(Employee e) {
        return e.getSalary() > 50000000 ? "high" : "low";
    }
}
